"""Module chính khởi chạy phần mềm QLCH_BanThuocNongDuoc."""

import sys
# Sử dụng công cụ PyQt để xây dựng UI form cho phần mềm QLCH_BanThuocNongDuoc
...
connection_string = (
    ...
    "Server=.;"
    "Database=QLCH_BanThuocNongDuoc;"
